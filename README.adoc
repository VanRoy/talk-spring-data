...
Ce projet à pour but de presenter les fonctionnalités de Spring Data.

Il contient une presentation de quelques slides ainsi que plusieurs applications de demonstration.
